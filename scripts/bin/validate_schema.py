#!/usr/bin/env python3
"""Validate JSON Lines records against the enrichment pipeline's schema contract.

Reads JSON objects from stdin (or a file), checks each record against the
required/optional field rules, and reports schema violations per line.
"""
import sys
import json
